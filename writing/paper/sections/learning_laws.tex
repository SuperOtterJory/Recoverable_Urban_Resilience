...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.85\linewidth]{../../results/multiobjective_footprint_lp_validation/figures/multiobjective_lp_frontier.png}
  \caption{Direct multi-objective LP recovery--footprint frontier. When observed footprint coverage is rewarded inside the LP objective, weak weights remain near-free tie-breakers, while large footprint gains require true recovery-gain loss.}
