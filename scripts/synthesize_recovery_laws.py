...
def load_tables(root: Path) -> dict[str, pd.DataFrame]:
    ...
    return {
        ...
        "fine_budget_lp_summary": read_csv(results / "fine_budget_lp_validation" / "tables" / "fine_budget_lp_summary.csv"),
        "fine_budget_lp_phase": read_csv(results / "fine_budget_lp_validation" / "tables" / "fine_budget_lp_phase_tests.csv"),
        "fine_budget_lp_metrics": read_json_table(results / "fine_budget_lp_validation" / "tables" / "fine_budget_lp_metrics.json"),
        ...
        "footprint_aware_metrics": read_json_table(results / "footprint_aware_law_frontier" / "tables" / "footprint_aware_law_metrics.json"),
        "footprint_aware_summary": read_csv(results / "footprint_aware_law_frontier" / "tables" / "footprint_aware_score_summary.csv"),
        "footprint_aware_frontier": read_csv(results / "footprint_aware_law_frontier" / "tables" / "footprint_aware_pareto_frontier.csv"),
        "footprint_policy_metrics": read_json_table(results / "footprint_aware_policy_validation" / "tables" / "footprint_aware_policy_metrics.json"),
        "footprint_policy_summary": read_csv(results / "footprint_aware_policy_validation" / "tables" / "footprint_aware_policy_summary.csv"),
        "footprint_policy_events": read_csv(results / "footprint_aware_policy_validation" / "tables" / "footprint_aware_policy_event_metrics.csv"),
        ...
        "multiobjective_footprint_lp_metrics": read_json_table(results / "multiobjective_footprint_lp_validation" / "tables" / "multiobjective_lp_metrics.json"),
        "multiobjective_footprint_lp_summary": read_csv(results / "multiobjective_footprint_lp_validation" / "tables" / "multiobjective_lp_summary.csv"),
        "multiobjective_footprint_lp_frontier": read_csv(results / "multiobjective_footprint_lp_validation" / "tables" / "multiobjective_lp_frontier.csv"),
        "multiobjective_footprint_lp_events": read_csv(results / "multiobjective_footprint_lp_validation" / "tables" / "multiobjective_lp_event_best.csv"),
        "broader_multiobjective_footprint_lp_metrics": read_json_table(results / "broader_multiobjective_footprint_lp_validation" / "tables" / "broader_multiobjective_lp_metrics.json"),
        "broader_multiobjective_footprint_lp_summary": read_csv(results / "broader_multiobjective_footprint_lp_validation" / "tables" / "broader_multiobjective_lp_summary.csv"),
        "broader_multiobjective_footprint_lp_frontier": read_csv(results / "broader_multiobjective_footprint_lp_validation" / "tables" / "broader_multiobjective_lp_frontier.csv"),
        "broader_multiobjective_footprint_lp_events": read_csv(results / "broader_multiobjective_footprint_lp_validation" / "tables" / "broader_multiobjective_lp_event_best.csv"),
        "new_york_footprint_boundary_metrics": read_json_table(results / "new_york_footprint_lp_boundary" / "tables" / "new_york_boundary_metrics.json"),
        "new_york_footprint_boundary_events": read_csv(results / "new_york_footprint_lp_boundary" / "tables" / "new_york_boundary_event_metrics.csv"),
        "new_york_footprint_boundary_size": read_csv(results / "new_york_footprint_lp_boundary" / "tables" / "new_york_boundary_size_comparison.csv"),
        "new_york_active_set_metrics": read_json_table(results / "new_york_active_set_screening" / "tables" / "new_york_active_set_metrics.json"),
        "new_york_active_set_summary": read_csv(results / "new_york_active_set_screening" / "tables" / "new_york_active_set_threshold_summary.csv"),
        "new_york_active_set_events": read_csv(results / "new_york_active_set_screening" / "tables" / "new_york_active_set_event_metrics.csv"),
        ...
        "parameter_lp_selection_summary": read_csv(results / "parameter_lp_selection_laws" / "tables" / "parameter_lp_selection_scenario_summary.csv"),
        "parameter_lp_selection_city": read_csv(results / "parameter_lp_selection_laws" / "tables" / "parameter_lp_selection_city_summary.csv"),
        "parameter_lp_selection_metrics": read_json_table(results / "parameter_lp_selection_laws" / "tables" / "parameter_lp_selection_metrics.json"),
    }
...
def build_metrics(data: dict[str, pd.DataFrame]) -> dict[str, Any]:
    ...
    fine_budget_lp_metrics = one_row(data["fine_budget_lp_metrics"])
    ...
    multiobjective_footprint_lp_metrics = one_row(data["multiobjective_footprint_lp_metrics"])
    broader_multiobjective_footprint_lp_metrics = one_row(data["broader_multiobjective_footprint_lp_metrics"])
    new_york_footprint_boundary_metrics = one_row(data["new_york_footprint_boundary_metrics"])
    new_york_active_set_metrics = one_row(data["new_york_active_set_metrics"])
    ...
    metrics: dict[str, Any] = {
        ...
        "fine_budget_lp_n_selected_events": safe_int(fine_budget_lp_metrics.get("n_selected_events")),
        "fine_budget_lp_n_jobs": safe_int(fine_budget_lp_metrics.get("n_lp_jobs")),
        "fine_budget_lp_n_optimal_jobs": safe_int(fine_budget_lp_metrics.get("n_optimal_lp_jobs")),
        "fine_budget_lp_gain_peak_budget": safe_float(fine_budget_lp_metrics.get("lp_gain_peak_budget")),
        "fine_budget_lp_gain_interior_peak_supported": parse_bool(fine_budget_lp_metrics.get("lp_gain_interior_peak_supported")),
        "fine_budget_lp_gain_monotone_increasing": parse_bool(fine_budget_lp_metrics.get("lp_gain_monotone_increasing")),
        "fine_budget_lp_gain_per_budget_peak_budget": safe_float(fine_budget_lp_metrics.get("lp_gain_per_budget_peak_budget")),
        "fine_budget_lp_gain_per_budget_monotone_decreasing": parse_bool(fine_budget_lp_metrics.get("lp_gain_per_budget_monotone_decreasing")),
        "fine_budget_lp_law_random_abs_peak_budget": safe_float(fine_budget_lp_metrics.get("law_random_abs_peak_budget")),
        "fine_budget_lp_law_random_abs_interior_peak_supported": parse_bool(fine_budget_lp_metrics.get("law_random_abs_interior_peak_supported")),
        "fine_budget_lp_law_random_fraction_peak_budget": safe_float(fine_budget_lp_metrics.get("law_random_fraction_peak_budget")),
        "fine_budget_lp_law_random_fraction_monotone_decreasing": parse_bool(fine_budget_lp_metrics.get("law_random_fraction_monotone_decreasing")),
        "fine_budget_lp_base_law_fraction_of_lp_gain": safe_float(fine_budget_lp_metrics.get("base_budget_law_fraction_of_lp_gain")),
        "fine_budget_lp_base_random_fraction_of_lp_gain": safe_float(fine_budget_lp_metrics.get("base_budget_random_fraction_of_lp_gain")),
        "fine_budget_lp_base_law_minus_random_fraction_of_lp_gain": safe_float(fine_budget_lp_metrics.get("base_budget_law_minus_random_fraction_of_lp_gain")),
        "fine_budget_lp_mean_law_fraction_of_lp_gain_all_budgets": safe_float(fine_budget_lp_metrics.get("mean_law_fraction_of_lp_gain_all_budgets")),
        ...
        "parameter_lp_selection_n_event_scenarios": safe_int(parameter_lp_selection_metrics.get("n_event_scenarios")),
        "parameter_lp_selection_n_cities": safe_int(parameter_lp_selection_metrics.get("n_cities")),
        "parameter_lp_selection_n_parameter_scenarios": safe_int(parameter_lp_selection_metrics.get("n_parameter_scenarios")),
        "parameter_lp_selection_n_selected_actions": safe_int(parameter_lp_selection_metrics.get("n_lp_selected_actions")),
        "parameter_lp_selection_activated_top20_cost_share": safe_float(parameter_lp_selection_metrics.get("mean_activated_top20_selected_cost_share")),
        "parameter_lp_selection_deficit_top20_cost_share": safe_float(parameter_lp_selection_metrics.get("mean_deficit_top20_selected_cost_share")),
        "parameter_lp_selection_exposure_top20_cost_share": safe_float(parameter_lp_selection_metrics.get("mean_exposure_top20_selected_cost_share")),
        "parameter_lp_selection_structure_top20_cost_share": safe_float(parameter_lp_selection_metrics.get("mean_structure_top20_selected_cost_share")),
        "parameter_lp_selection_simple_union_top20_cost_share": safe_float(parameter_lp_selection_metrics.get("mean_simple_union_top20_selected_cost_share")),
        "parameter_lp_selection_hidden_simple_top20_cost_share": safe_float(parameter_lp_selection_metrics.get("mean_hidden_from_simple_union_top20_selected_cost_share")),
        "parameter_lp_selection_below_structure_top20_cost_share": safe_float(parameter_lp_selection_metrics.get("mean_below_structure_top20_selected_cost_share")),
        "parameter_lp_selection_activated_minus_best_simple_top20_cost_share": safe_float(parameter_lp_selection_metrics.get("mean_activated_minus_best_simple_top20_selected_cost_share")),
        "parameter_lp_selection_cost_share_R": safe_float(parameter_lp_selection_metrics.get("mean_lp_cost_share_R")),
        "parameter_lp_selection_cost_share_C": safe_float(parameter_lp_selection_metrics.get("mean_lp_cost_share_C")),
        "parameter_lp_selection_cost_share_S": safe_float(parameter_lp_selection_metrics.get("mean_lp_cost_share_S")),
        "parameter_lp_selection_worst_hidden_scenario": str(parameter_lp_selection_metrics.get("worst_hidden_selected_scenario", "")),
        "parameter_lp_selection_worst_hidden_scenario_value": safe_float(parameter_lp_selection_metrics.get("worst_hidden_selected_scenario_value")),
        ...
        "spatial_footprint_n_events": safe_int(spatial_footprint_metrics.get("n_events_with_footprint")),
        "spatial_footprint_n_cities": safe_int(spatial_footprint_metrics.get("n_cities_with_footprint")),
        "spatial_footprint_mean_template_cosine": safe_float(spatial_footprint_metrics.get("mean_footprint_template_cosine")),
        "spatial_footprint_median_template_cosine": safe_float(spatial_footprint_metrics.get("median_footprint_template_cosine")),
        "spatial_footprint_mean_top20_template_jaccard": safe_float(spatial_footprint_metrics.get("mean_top20_footprint_template_jaccard")),
        "spatial_footprint_template_top5_capture": safe_float(spatial_footprint_metrics.get("mean_template_top_5pct_captures_footprint_share")),
        "spatial_footprint_top5_zone_share": safe_float(spatial_footprint_metrics.get("mean_footprint_top_5pct_zone_share")),
        "spatial_footprint_effective_zone_count": safe_float(spatial_footprint_metrics.get("mean_footprint_effective_zone_count")),
        ...
        "hybrid_lp_n_selected_events": safe_int(hybrid_lp_metrics.get("n_selected_events")),
        "hybrid_lp_n_successful_events": safe_int(hybrid_lp_metrics.get("n_successful_lp_events")),
        "hybrid_lp_n_optimal_events": safe_int(hybrid_lp_metrics.get("n_optimal_lp_events")),
        "hybrid_lp_n_cities": safe_int(hybrid_lp_metrics.get("n_cities")),
        "hybrid_lp_base_selected_unit_footprint_mass": safe_float(hybrid_lp_metrics.get("mean_base_selected_unit_footprint_mass")),
        "hybrid_lp_hybrid_selected_unit_footprint_mass": safe_float(hybrid_lp_metrics.get("mean_hybrid_selected_unit_footprint_mass")),
        "hybrid_lp_delta_selected_unit_footprint_mass": safe_float(hybrid_lp_metrics.get("mean_delta_selected_unit_footprint_mass")),
        "hybrid_lp_base_cost_weighted_footprint_score": safe_float(hybrid_lp_metrics.get("mean_base_selected_cost_weighted_footprint_score")),
        "hybrid_lp_hybrid_cost_weighted_footprint_score": safe_float(hybrid_lp_metrics.get("mean_hybrid_selected_cost_weighted_footprint_score")),
        "hybrid_lp_delta_cost_weighted_footprint_score": safe_float(hybrid_lp_metrics.get("mean_delta_selected_cost_weighted_footprint_score")),
        "hybrid_lp_selected_action_jaccard": safe_float(hybrid_lp_metrics.get("mean_selected_action_jaccard")),
        "hybrid_lp_selected_unit_jaccard": safe_float(hybrid_lp_metrics.get("mean_selected_unit_jaccard")),
        ...
        "footprint_aware_n_scores": safe_int(footprint_aware_metrics.get("n_scores")),
        "footprint_aware_n_frontier_scores": safe_int(footprint_aware_metrics.get("n_frontier_scores")),
        "footprint_aware_small_selected_capture": safe_float(footprint_aware_metrics.get("small_signal_selected_cost_capture_top20")),
        "footprint_aware_small_footprint_mass": safe_float(footprint_aware_metrics.get("small_signal_footprint_mass_top5_units")),
        "footprint_aware_finite_selected_capture": safe_float(footprint_aware_metrics.get("finite_value_selected_cost_capture_top20")),
        "footprint_aware_finite_footprint_mass": safe_float(footprint_aware_metrics.get("finite_value_footprint_mass_top5_units")),
        "footprint_aware_footprint_only_selected_capture": safe_float(footprint_aware_metrics.get("footprint_only_selected_cost_capture_top20")),
        "footprint_aware_footprint_only_footprint_mass": safe_float(footprint_aware_metrics.get("footprint_only_footprint_mass_top5_units")),
        "footprint_aware_best_no_loss_score": str(footprint_aware_metrics.get("best_no_loss_score_id", "")),
        "footprint_aware_best_no_loss_selected_capture": safe_float(footprint_aware_metrics.get("best_no_loss_selected_cost_capture_top20")),
        "footprint_aware_best_no_loss_footprint_mass": safe_float(footprint_aware_metrics.get("best_no_loss_footprint_mass_top5_units")),
        "footprint_aware_best_no_loss_delta_selected": safe_float(footprint_aware_metrics.get("best_no_loss_delta_selected_capture")),
        "footprint_aware_best_no_loss_delta_footprint": safe_float(footprint_aware_metrics.get("best_no_loss_delta_footprint_mass")),
        "footprint_aware_best_footprint_score": str(footprint_aware_metrics.get("best_footprint_score_id", "")),
        "footprint_aware_best_footprint_selected_capture": safe_float(footprint_aware_metrics.get("best_footprint_selected_cost_capture_top20")),
        "footprint_aware_best_footprint_mass": safe_float(footprint_aware_metrics.get("best_footprint_mass_top5_units")),
        "footprint_aware_best_footprint_delta_selected": safe_float(footprint_aware_metrics.get("best_footprint_delta_selected_capture")),
        "footprint_aware_best_support_score": str(footprint_aware_metrics.get("best_support_score_id", "")),
        "footprint_aware_best_support_selected_capture": safe_float(footprint_aware_metrics.get("best_support_selected_cost_capture_top20")),
        "footprint_aware_best_support_footprint_mass": safe_float(footprint_aware_metrics.get("best_support_footprint_mass_top5_units")),
        "footprint_policy_n_events": safe_int(footprint_policy_metrics.get("n_events")),
        "footprint_policy_n_policies": safe_int(footprint_policy_metrics.get("n_policies")),
        "footprint_policy_small_fraction": safe_float(footprint_policy_metrics.get("small_signal_fraction_of_hybrid_lp_gain")),
        "footprint_policy_small_top5_mass": safe_float(footprint_policy_metrics.get("small_signal_top5_footprint_mass")),
        "footprint_policy_finite_x_small_fraction": safe_float(footprint_policy_metrics.get("finite_x_small_fraction_of_hybrid_lp_gain")),
        "footprint_policy_finite_x_small_top5_mass": safe_float(footprint_policy_metrics.get("finite_x_small_top5_footprint_mass")),
        "footprint_policy_finite_x_small_delta_fraction": safe_float(footprint_policy_metrics.get("finite_x_small_delta_fraction")),
        "footprint_policy_finite_x_small_delta_top5": safe_float(footprint_policy_metrics.get("finite_x_small_delta_top5_footprint")),
        "footprint_policy_activation_0p5_fraction": safe_float(footprint_policy_metrics.get("activation_plus_0p5_footprint_fraction")),
        "footprint_policy_activation_0p5_top5_mass": safe_float(footprint_policy_metrics.get("activation_plus_0p5_footprint_top5_mass")),
        "footprint_policy_activation_0p5_delta_fraction": safe_float(footprint_policy_metrics.get("activation_plus_0p5_footprint_delta_fraction")),
        "footprint_policy_activation_0p5_delta_top5": safe_float(footprint_policy_metrics.get("activation_plus_0p5_footprint_delta_top5")),
        "footprint_policy_footprint_only_fraction": safe_float(footprint_policy_metrics.get("footprint_only_fraction_of_hybrid_lp_gain")),
        "footprint_policy_footprint_only_top5_mass": safe_float(footprint_policy_metrics.get("footprint_only_top5_footprint_mass")),
        "footprint_policy_footprint_only_delta_fraction": safe_float(footprint_policy_metrics.get("footprint_only_delta_fraction")),
        "footprint_policy_best_nonnegative_score": str(footprint_policy_metrics.get("best_nonnegative_gain_policy", "")),
        "footprint_policy_best_nonnegative_fraction": safe_float(footprint_policy_metrics.get("best_nonnegative_gain_fraction")),
        "footprint_policy_best_nonnegative_top5_mass": safe_float(footprint_policy_metrics.get("best_nonnegative_gain_top5_footprint_mass")),
        "footprint_policy_best_nonnegative_delta_fraction": safe_float(footprint_policy_metrics.get("best_nonnegative_gain_delta_fraction")),
        "footprint_policy_best_nonnegative_delta_top5": safe_float(footprint_policy_metrics.get("best_nonnegative_gain_delta_top5_footprint")),
        "footprint_policy_best_near_no_loss_score": str(footprint_policy_metrics.get("best_near_no_loss_policy", "")),
        "footprint_policy_best_near_no_loss_fraction": safe_float(footprint_policy_metrics.get("best_near_no_loss_fraction")),
        "footprint_policy_best_near_no_loss_top5_mass": safe_float(footprint_policy_metrics.get("best_near_no_loss_top5_footprint_mass")),
        "footprint_policy_best_near_no_loss_delta_fraction": safe_float(footprint_policy_metrics.get("best_near_no_loss_delta_fraction")),
        "footprint_policy_best_near_no_loss_delta_top5": safe_float(footprint_policy_metrics.get("best_near_no_loss_delta_top5_footprint")),
        "residual_footprint_n_events": safe_int(residual_footprint_metrics.get("n_events")),
        "residual_footprint_n_policies": safe_int(residual_footprint_metrics.get("n_policies")),
        "residual_footprint_fraction": safe_float(residual_footprint_metrics.get("residual_fraction_of_hybrid_lp_gain")),
        "residual_footprint_top5_mass": safe_float(residual_footprint_metrics.get("residual_top5_footprint_mass")),
        "residual_footprint_cost_weighted": safe_float(residual_footprint_metrics.get("residual_cost_weighted_footprint")),
        "residual_footprint_weak_policy": str(residual_footprint_metrics.get("weak_footprint_policy", "")),
        "residual_footprint_weak_fraction": safe_float(residual_footprint_metrics.get("weak_footprint_fraction")),
        "residual_footprint_weak_top5_mass": safe_float(residual_footprint_metrics.get("weak_footprint_top5_mass")),
        "residual_footprint_weak_delta_fraction": safe_float(residual_footprint_metrics.get("weak_footprint_delta_fraction")),
        "residual_footprint_weak_delta_top5": safe_float(residual_footprint_metrics.get("weak_footprint_delta_top5")),
        "residual_footprint_strong_policy": str(residual_footprint_metrics.get("strong_footprint_policy", "")),
        "residual_footprint_strong_fraction": safe_float(residual_footprint_metrics.get("strong_footprint_fraction")),
        "residual_footprint_strong_top5_mass": safe_float(residual_footprint_metrics.get("strong_footprint_top5_mass")),
        "residual_footprint_strong_delta_fraction": safe_float(residual_footprint_metrics.get("strong_footprint_delta_fraction")),
        "residual_footprint_strong_delta_top5": safe_float(residual_footprint_metrics.get("strong_footprint_delta_top5")),
        "residual_footprint_gated_policy": str(residual_footprint_metrics.get("gated_footprint_policy", "")),
        "residual_footprint_gated_fraction": safe_float(residual_footprint_metrics.get("gated_footprint_fraction")),
        "residual_footprint_gated_top5_mass": safe_float(residual_footprint_metrics.get("gated_footprint_top5_mass")),
        "residual_footprint_gated_delta_fraction": safe_float(residual_footprint_metrics.get("gated_footprint_delta_fraction")),
        "residual_footprint_gated_delta_top5": safe_float(residual_footprint_metrics.get("gated_footprint_delta_top5")),
        "residual_footprint_finite_policy": str(residual_footprint_metrics.get("finite_policy", "")),
        "residual_footprint_finite_fraction": safe_float(residual_footprint_metrics.get("finite_fraction")),
        "residual_footprint_finite_top5_mass": safe_float(residual_footprint_metrics.get("finite_top5_mass")),
        "residual_footprint_finite_delta_fraction": safe_float(residual_footprint_metrics.get("finite_delta_fraction")),
        "residual_footprint_finite_delta_top5": safe_float(residual_footprint_metrics.get("finite_delta_top5")),
        "residual_footprint_best_nonnegative_policy": str(residual_footprint_metrics.get("best_nonnegative_policy", "")),
        "residual_footprint_best_nonnegative_fraction": safe_float(residual_footprint_metrics.get("best_nonnegative_fraction")),
        "residual_footprint_best_nonnegative_top5_mass": safe_float(residual_footprint_metrics.get("best_nonnegative_top5_mass")),
        "residual_footprint_best_nonnegative_delta_fraction": safe_float(residual_footprint_metrics.get("best_nonnegative_delta_fraction")),
        "residual_footprint_best_nonnegative_delta_top5": safe_float(residual_footprint_metrics.get("best_nonnegative_delta_top5")),
        "residual_footprint_best_near_no_loss_policy": str(residual_footprint_metrics.get("best_near_no_loss_policy", "")),
        "residual_footprint_best_near_no_loss_fraction": safe_float(residual_footprint_metrics.get("best_near_no_loss_fraction")),
        ...
        "multiobjective_footprint_lp_n_events": safe_int(multiobjective_footprint_lp_metrics.get("n_events")),
        "multiobjective_footprint_lp_n_lambdas": safe_int(multiobjective_footprint_lp_metrics.get("n_lambdas")),
        "multiobjective_footprint_lp_frontier_points": safe_int(multiobjective_footprint_lp_metrics.get("pareto_frontier_points")),
        "multiobjective_footprint_lp_lambda0_fraction": safe_float(multiobjective_footprint_lp_metrics.get("lambda0_fraction")),
        "multiobjective_footprint_lp_lambda0_top5_mass": safe_float(multiobjective_footprint_lp_metrics.get("lambda0_top5_footprint_mass")),
        "multiobjective_footprint_lp_lambda0_cost_weighted": safe_float(multiobjective_footprint_lp_metrics.get("lambda0_cost_weighted_footprint_mass")),
        "multiobjective_footprint_lp_max_gain_lambda": safe_float(multiobjective_footprint_lp_metrics.get("max_gain_lambda")),
        "multiobjective_footprint_lp_max_gain_fraction": safe_float(multiobjective_footprint_lp_metrics.get("max_gain_fraction")),
        "multiobjective_footprint_lp_max_gain_top5_mass": safe_float(multiobjective_footprint_lp_metrics.get("max_gain_top5_footprint_mass")),
        "multiobjective_footprint_lp_max_footprint_lambda": safe_float(multiobjective_footprint_lp_metrics.get("max_footprint_lambda")),
        "multiobjective_footprint_lp_max_footprint_fraction": safe_float(multiobjective_footprint_lp_metrics.get("max_footprint_fraction")),
        "multiobjective_footprint_lp_max_footprint_top5_mass": safe_float(multiobjective_footprint_lp_metrics.get("max_footprint_top5_mass")),
        "multiobjective_footprint_lp_best_lambda_loss_0p005": safe_float(multiobjective_footprint_lp_metrics.get("best_lambda_loss_le_0p005")),
        "multiobjective_footprint_lp_best_fraction_loss_0p005": safe_float(multiobjective_footprint_lp_metrics.get("best_fraction_loss_le_0p005")),
        "multiobjective_footprint_lp_best_delta_fraction_loss_0p005": safe_float(multiobjective_footprint_lp_metrics.get("best_delta_fraction_loss_le_0p005")),
        "multiobjective_footprint_lp_best_top5_loss_0p005": safe_float(multiobjective_footprint_lp_metrics.get("best_top5_footprint_loss_le_0p005")),
        "multiobjective_footprint_lp_best_delta_top5_loss_0p005": safe_float(multiobjective_footprint_lp_metrics.get("best_delta_top5_footprint_loss_le_0p005")),
        "multiobjective_footprint_lp_best_lambda_loss_0p01": safe_float(multiobjective_footprint_lp_metrics.get("best_lambda_loss_le_0p01")),
        "multiobjective_footprint_lp_best_fraction_loss_0p01": safe_float(multiobjective_footprint_lp_metrics.get("best_fraction_loss_le_0p01")),
        "multiobjective_footprint_lp_best_delta_fraction_loss_0p01": safe_float(multiobjective_footprint_lp_metrics.get("best_delta_fraction_loss_le_0p01")),
        "multiobjective_footprint_lp_best_top5_loss_0p01": safe_float(multiobjective_footprint_lp_metrics.get("best_top5_footprint_loss_le_0p01")),
        "multiobjective_footprint_lp_best_delta_top5_loss_0p01": safe_float(multiobjective_footprint_lp_metrics.get("best_delta_top5_footprint_loss_le_0p01")),
        "multiobjective_footprint_lp_event_mean_delta_top5_loss_0p01": safe_float(multiobjective_footprint_lp_metrics.get("event_mean_delta_top5_loss_le_0p01")),
        "multiobjective_footprint_lp_event_positive_delta_share_loss_0p01": safe_float(multiobjective_footprint_lp_metrics.get("event_positive_delta_share_loss_le_0p01")),
        "broader_multiobjective_footprint_lp_n_selected_events": safe_int(broader_multiobjective_footprint_lp_metrics.get("n_selected_events")),
        "broader_multiobjective_footprint_lp_n_events": safe_int(broader_multiobjective_footprint_lp_metrics.get("n_events")),
        "broader_multiobjective_footprint_lp_n_lambdas": safe_int(broader_multiobjective_footprint_lp_metrics.get("n_lambdas")),
        "broader_multiobjective_footprint_lp_frontier_points": safe_int(broader_multiobjective_footprint_lp_metrics.get("pareto_frontier_points")),
        "broader_multiobjective_footprint_lp_lambda0_fraction": safe_float(broader_multiobjective_footprint_lp_metrics.get("lambda0_fraction")),
        "broader_multiobjective_footprint_lp_lambda0_top5_mass": safe_float(broader_multiobjective_footprint_lp_metrics.get("lambda0_top5_footprint_mass")),
        "broader_multiobjective_footprint_lp_max_footprint_lambda": safe_float(broader_multiobjective_footprint_lp_metrics.get("max_footprint_lambda")),
        "broader_multiobjective_footprint_lp_max_footprint_fraction": safe_float(broader_multiobjective_footprint_lp_metrics.get("max_footprint_fraction")),
        "broader_multiobjective_footprint_lp_max_footprint_top5_mass": safe_float(broader_multiobjective_footprint_lp_metrics.get("max_footprint_top5_mass")),
        "broader_multiobjective_footprint_lp_best_lambda_loss_0p005": safe_float(broader_multiobjective_footprint_lp_metrics.get("best_lambda_loss_le_0p005")),
        "broader_multiobjective_footprint_lp_best_fraction_loss_0p005": safe_float(broader_multiobjective_footprint_lp_metrics.get("best_fraction_loss_le_0p005")),
        "broader_multiobjective_footprint_lp_best_delta_fraction_loss_0p005": safe_float(broader_multiobjective_footprint_lp_metrics.get("best_delta_fraction_loss_le_0p005")),
        "broader_multiobjective_footprint_lp_best_top5_loss_0p005": safe_float(broader_multiobjective_footprint_lp_metrics.get("best_top5_footprint_loss_le_0p005")),
        "broader_multiobjective_footprint_lp_best_delta_top5_loss_0p005": safe_float(broader_multiobjective_footprint_lp_metrics.get("best_delta_top5_footprint_loss_le_0p005")),
        "broader_multiobjective_footprint_lp_best_lambda_loss_0p02": safe_float(broader_multiobjective_footprint_lp_metrics.get("best_lambda_loss_le_0p02")),
        "broader_multiobjective_footprint_lp_best_delta_fraction_loss_0p02": safe_float(broader_multiobjective_footprint_lp_metrics.get("best_delta_fraction_loss_le_0p02")),
        "broader_multiobjective_footprint_lp_best_delta_top5_loss_0p02": safe_float(broader_multiobjective_footprint_lp_metrics.get("best_delta_top5_footprint_loss_le_0p02")),
        "broader_multiobjective_footprint_lp_excluded_cities": str(broader_multiobjective_footprint_lp_metrics.get("excluded_cities", "")),
        "new_york_footprint_boundary_n_events": safe_int(new_york_footprint_boundary_metrics.get("n_selected_new_york_events")),
        "new_york_footprint_boundary_prior_attempted": safe_int(new_york_footprint_boundary_metrics.get("n_prior_hybrid_lp_attempted")),
        "new_york_footprint_boundary_prior_time_limit": safe_int(new_york_footprint_boundary_metrics.get("n_prior_hybrid_lp_time_limit_or_error")),
        "new_york_footprint_boundary_prior_time_limit_event_ids": str(new_york_footprint_boundary_metrics.get("prior_time_limit_event_ids", "")),
        "new_york_footprint_boundary_mean_delta_finite_top5": safe_float(new_york_footprint_boundary_metrics.get("mean_delta_finite_top5_mass")),
        "new_york_footprint_boundary_mean_base_finite_top5": safe_float(new_york_footprint_boundary_metrics.get("mean_base_finite_top5_mass")),
        "new_york_footprint_boundary_mean_hybrid_finite_top5": safe_float(new_york_footprint_boundary_metrics.get("mean_hybrid_finite_top5_mass")),
        "new_york_footprint_boundary_mean_action_jaccard": safe_float(new_york_footprint_boundary_metrics.get("mean_finite_top5_action_jaccard")),
        "new_york_footprint_boundary_max_units": safe_int(new_york_footprint_boundary_metrics.get("max_new_york_units")),
        "new_york_footprint_boundary_max_variables": safe_int(new_york_footprint_boundary_metrics.get("max_new_york_estimated_variables")),
        "new_york_footprint_boundary_max_constraints": safe_int(new_york_footprint_boundary_metrics.get("max_new_york_estimated_constraints")),
        "new_york_footprint_boundary_max_access_terms": safe_int(new_york_footprint_boundary_metrics.get("max_new_york_access_terms")),
        "new_york_footprint_boundary_v42_max_runtime": safe_float(new_york_footprint_boundary_metrics.get("v42_max_runtime_seconds")),
        "new_york_footprint_boundary_units_ratio": safe_float(new_york_footprint_boundary_metrics.get("ny_to_v42_max_units_ratio")),
        "new_york_footprint_boundary_variable_ratio": safe_float(new_york_footprint_boundary_metrics.get("ny_to_v42_max_variables_ratio")),
        "new_york_footprint_boundary_constraint_ratio": safe_float(new_york_footprint_boundary_metrics.get("ny_to_v42_max_constraints_ratio")),
        "new_york_footprint_boundary_access_ratio": safe_float(new_york_footprint_boundary_metrics.get("ny_to_v42_max_access_terms_ratio")),
        "new_york_active_set_n_events": safe_int(new_york_active_set_metrics.get("n_events")),
        "new_york_active_set_recommended_mode": str(new_york_active_set_metrics.get("recommended_screen_mode", "")),
        "new_york_active_set_recommended_strategy": str(new_york_active_set_metrics.get("recommended_strategy", "")),
        "new_york_active_set_recommended_fraction": safe_float(new_york_active_set_metrics.get("recommended_fraction")),
        "new_york_active_set_recommended_active_units": safe_float(new_york_active_set_metrics.get("recommended_mean_active_units")),
        "new_york_active_set_recommended_active_unit_fraction": safe_float(new_york_active_set_metrics.get("recommended_mean_active_unit_fraction")),
        "new_york_active_set_recommended_active_token_fraction": safe_float(new_york_active_set_metrics.get("recommended_mean_active_action_token_fraction")),
        "new_york_active_set_recommended_variable_reduction": safe_float(new_york_active_set_metrics.get("recommended_mean_variable_reduction")),
        "new_york_active_set_recommended_small_capture": safe_float(new_york_active_set_metrics.get("recommended_mean_small_signal_capture")),
        "new_york_active_set_recommended_finite_capture": safe_float(new_york_active_set_metrics.get("recommended_mean_finite_capture")),
        "new_york_active_set_recommended_footprint_capture": safe_float(new_york_active_set_metrics.get("recommended_mean_footprint_capture")),
        "new_york_active_set_recommended_destination_capture": safe_float(new_york_active_set_metrics.get("recommended_mean_destination_importance_capture")),
        "new_york_active_set_unit_block_small_capture": safe_float(new_york_active_set_metrics.get("unit_block_10pct_small_signal_capture")),
        "new_york_active_set_unit_block_finite_capture": safe_float(new_york_active_set_metrics.get("unit_block_10pct_finite_capture")),
        "new_york_active_set_unit_block_footprint_capture": safe_float(new_york_active_set_metrics.get("unit_block_10pct_footprint_capture")),
        "new_york_active_set_full_capture_fraction": safe_float(new_york_active_set_metrics.get("smallest_all_threshold_fraction")),
        "new_york_active_set_full_capture_active_token_fraction": safe_float(new_york_active_set_metrics.get("smallest_all_threshold_active_action_token_fraction")),
        "new_york_active_set_full_capture_variable_reduction": safe_float(new_york_active_set_metrics.get("smallest_all_threshold_variable_reduction")),
        "new_york_active_set_full_capture_small_min": safe_float(new_york_active_set_metrics.get("smallest_all_threshold_small_capture_min")),
        "new_york_active_set_full_capture_finite_min": safe_float(new_york_active_set_metrics.get("smallest_all_threshold_finite_capture_min")),
        "new_york_active_set_full_capture_footprint_min": safe_float(new_york_active_set_metrics.get("smallest_all_threshold_footprint_capture_min")),
...
def build_evidence_ladder(metrics: dict[str, Any]) -> pd.DataFrame:
    rows = [
        ...
        {
            "version": "V28",
            "evidence_step": "Representative fine-budget LP closure",
            "main_question": "Does the fine-budget law remain valid when each budget scale is compared with a re-solved full LP optimum?",
            "key_metric": "fine_budget_lp_mean_law_fraction_of_lp_gain_all_budgets",
        ...
        {
            "version": "V30",
            "evidence_step": "Exact LP selected-action support audit",
            "main_question": "Do the same action-law patterns appear in full-LP selected actions under parameter ensembles?",
            "key_metric": "parameter_lp_selection_activated_top20_selected_cost_share",
        ...
        {
            "version": "V33",
            "evidence_step": "TMC-derived event-zone footprint proxy",
            "main_question": "Is there observed within-city spatial footprint signal beyond the OD vulnerability template?",
            "key_metric": "top20_footprint_template_jaccard",
        ...
        {
            "version": "V35",
            "evidence_step": "Representative hybrid-footprint full LP closure",
            "main_question": "Do first-order footprint shifts become optimized intervention support?",
            "key_metric": "selected_unit_footprint_mass_gain",
        ...
        {
            "version": "V37",
            "evidence_step": "Footprint-aware law frontier",
            "main_question": "Can footprint enter the action law without sacrificing LP-support alignment?",
            "key_metric": "best_no_loss_footprint_mass_gain",
            "value": metrics["footprint_aware_best_no_loss_delta_footprint"],
            "interpretation": "A footprint-aware score gated by small-signal rank can increase footprint coverage while preserving nearly all selected-support capture; footprint-only ranking remains a poor recovery-action law.",
        },
        {
            "version": "V38",
            "evidence_step": "Footprint-aware finite-budget policy validation",
            "main_question": "Does a footprint-aware score remain useful when used as an actual finite-budget replay policy?",
            "key_metric": "best_nonnegative_gain_footprint_mass_gain",
            "value": metrics["footprint_policy_best_nonnegative_delta_top5"],
            "interpretation": "Weak footprint weighting can improve footprint coverage without reducing replay gain, but stronger finite/footprint rankings lose finite-budget recovery gain; footprint is a secondary tie-breaking refinement, not a replacement policy objective.",
        },
        {
            "version": "V39",
            "evidence_step": "Adaptive residual footprint-aware policy validation",
        ...
        {
            "version": "V41",
            "evidence_step": "Explicit multi-objective footprint LP validation",
            "main_question": "Does the recovery-footprint frontier still appear when footprint enters the LP objective itself?",
            "key_metric": "best_0p005_loss_explicit_lp_footprint_mass_gain",
            "value": metrics["multiobjective_footprint_lp_best_delta_top5_loss_0p005"],
            "interpretation": "Solving 42 explicit multi-objective LPs confirms the boundary: a small footprint objective weight can raise observed-footprint coverage with almost no true-loss penalty, while larger footprint coverage requires a real sacrifice in recovery gain.",
        },
        {
            "version": "V42",
            "evidence_step": "Broader explicit multi-objective footprint LP closure",
            "main_question": "Does the explicit recovery-footprint frontier generalize beyond the six representative hybrid events?",
            "key_metric": "broader_0p005_loss_explicit_lp_footprint_mass_gain",
            "value": metrics["broader_multiobjective_footprint_lp_best_delta_top5_loss_0p005"],
            "interpretation": "Solving 36 additional explicit LPs across 12 footprint-sensitive non-New-York city-events preserves the same structure: lambda=0.02 raises footprint coverage with less than 0.001 LP-gain loss, while lambda=0.05 buys larger footprint coverage at a visible recovery-gain cost.",
        },
        {
            "version": "V43",
            "evidence_step": "New York-scale footprint LP boundary audit",
            "main_question": "Is the unresolved New York footprint case a lack of signal or a computational closure boundary?",
            "key_metric": "new_york_delta_finite_top5_footprint_mass",
            "value": metrics["new_york_footprint_boundary_mean_delta_finite_top5"],
            "interpretation": "The selected New York events have strong observed-footprint signal, but the direct footprint LP is roughly 2.2x the largest V42 closed model by variables and 2.1x by access terms; this supports a computational-boundary caveat rather than a footprint-law failure claim.",
        },
        {
            "version": "V44",
            "evidence_step": "New York active-set decomposition screen",
            "main_question": "Can New York-scale closure be reduced to a small set of active regions, or is action value diffuse?",
            "key_metric": "token_column_10pct_footprint_vs_value_capture",
            "value": metrics["new_york_active_set_recommended_footprint_capture"],
            "interpretation": "Token-column screening keeps the full New York state/access system but restricts candidate action columns. A 10% per-signal union captures high footprint mass but only about half of small-signal value; near-complete value capture needs most action columns. The next model step is column generation or active-set expansion, not simple regional downsampling.",
        },
    ]
    ...
    return pd.DataFrame(
        [
            ...
            },
            {
                ...
                "current_status": "V21 finds event-level top-tail concentration is strongly linked to decision-criticality; V32 shows top-5% value share has zero within-city variation in 5 of 7 cities under the OD-template calibration; V33 maps raw TMC speed abnormalities to OD zones for all 105 events; V34 shows hybrid footprint calibration strongly changes magnitude-aware finite values; V35 re-solves one representative hybrid LP per city and finds only a small shift in selected support; V36 audits the absorption mechanism; V37 tests footprint-aware score frontiers; V38 validates footprint-aware scores as static finite-budget replay policies; V39 tests adaptive residual footprint-aware policies; V40 scans a residual recovery-footprint lambda frontier; V41 solves 42 explicit multi-objective footprint LPs; V42 adds 36 broader explicit LPs across 12 footprint-sensitive non-New-York events; V43 audits the unresolved New York footprint LP as a scale boundary with strong footprint signal; V44 screens New York active action columns while keeping the full state/access system.",
                "implication": "The data contain usable event-specific spatial signal. Footprint-only ranking is not a recovery-action law; tiny footprint weighting can work as a secondary tie-breaker, while larger footprint coverage is a real recovery-vs-footprint frontier when optimized directly in the LP.",
                "next_step": "If footprint-specific recovery law becomes a main claim, close New York-scale direct LPs with column generation, active-set expansion, solver tuning, or warm-start bases and test city-specific social-preference weights.",
            },
            {
            ...
            },
            {
                ...
                "current_status": "V13 used low/base/high budget scales; V27 adds a 10-point budget sweep from 0.10 to 3.00 using action-value proxy allocation and LP replay dynamics; V28 re-solves 70 representative city-event-budget full LP optima on the same grid.",
                "implication": "The refined sweep and representative LP closure both reject an interior absolute-leverage peak: absolute LP gain and law-versus-random replay gain grow to the largest tested budget, while LP gain per budget and relative law advantage peak at the smallest budget and decline.",
                "next_step": "Expand the fine-budget LP closure beyond one representative event per city and add multiple random-policy seeds if budget phase shape becomes a central contribution.",
            },
            {
            ...
            },
            {
                ...
                "current_status": "V15 compares simple action heuristics against optimizer-derived marginal-value tokens inside each observed city-event; V29 repeats the diagnostic under 11 eta/cost/delay parameter scenarios; V30 re-solves 20 representative parameter LPs and audits actual selected-action support.",
                "implication": "The non-obvious action failures are not only a base-parameter artifact. Exact LP support is less hidden from combined deficit/exposure heuristics than first-order top-tail value, but structure-only remains a poor explanation of selected actions.",
                "next_step": "If observed intervention records become available, test whether real deployment outcomes follow the same activation mechanism; otherwise expand exact LP selected-action audits beyond representative parameter scenarios.",
            },
        ]
    )
...
def write_report(
    ...
    lines = [
        "# Recoverability Law Synthesis V44",
        "",
        "V44 adds a New York active-set screening boundary on top of the explicit recovery-footprint frontier. It asks whether the unresolved New York-scale footprint LP can be reduced by deleting most regions, or whether recovery value is diffuse enough to require column generation or active-set expansion.",
        "",
        "## 本版做了什么",
        "",
        "V42 keeps the V41 explicit LP objective and adds 36 broader LP solves on 12 non-New-York footprint-sensitive events. Each LP minimizes true recovery loss minus a cost-normalized observed-footprint deployment reward, then reports the frontier using the original true-loss objective rather than the modified objective.",
        "",
        "## 当前可写入论文的 law",
        "",
        ...
        "",
        "26. **Gated footprint-refinement law**: observed footprint should not replace the small-signal OD activation law, but it can refine the law when gated by small-signal or finite-rank activation. Footprint-only ranking captures footprint mass at the cost of losing LP-support alignment; gated footprint-aware scores increase footprint coverage while retaining nearly all selected-support capture.",
        "",
        ...
        "",
        "30. **Direct LP recovery-footprint frontier law**: when footprint enters the LP objective directly, lambda=0.02 raises top-5% allocated-unit footprint mass from about 0.0482 to 0.0734 while losing only 0.0004 of LP-gain fraction; larger weights raise footprint further but sharply reduce true recovery gain. This confirms that footprint is a secondary preference frontier, not a free recovery-value substitute.",
        "",
        "31. **Broader explicit footprint frontier law**: across 12 additional footprint-sensitive city-events, lambda=0.02 raises top-5% allocated-unit footprint mass from 0.0583 to 0.0754 while losing only 0.0008 of LP-gain fraction; lambda=0.05 raises footprint mass to 0.1085 but lowers gain/LP to 0.9887. This strengthens the claim that footprint is a stable secondary objective frontier across city structures, not an artifact of six representative events.",
        "",
        "32. **New York active-set decomposition boundary**: keeping all 1,940 New York zones and full OD access constraints, a token-column screen using value, footprint, and OD-structure signals can remove about 55.0% of variables while retaining 89.8% footprint mass, but it captures only 49.5% small-signal value and 60.7% finite value. Near-complete value capture needs 83.3% of action tokens, so New York closure should use column generation or active-set expansion rather than simple regional downsampling.",
        "",
        "## 关键指标",
        "",
        ...
        f"- exact LP selected-action audit: {metrics['parameter_lp_selection_n_event_scenarios']} representative parameter LPs, {metrics['parameter_lp_selection_n_selected_actions']:,} selected positive actions; activated top-20% captures {metrics['parameter_lp_selection_activated_top20_cost_share']:.1%} of LP-selected cost; simple union top-20% captures {metrics['parameter_lp_selection_simple_union_top20_cost_share']:.1%}; hidden from all simple top-20% = {metrics['parameter_lp_selection_hidden_simple_top20_cost_share']:.1%}",
        f"- exact LP selected-action nuance: one-factor top-20% captures are deficit {metrics['parameter_lp_selection_deficit_top20_cost_share']:.1%}, exposure {metrics['parameter_lp_selection_exposure_top20_cost_share']:.1%}, structure {metrics['parameter_lp_selection_structure_top20_cost_share']:.1%}; below structure top-20% selected cost = {metrics['parameter_lp_selection_below_structure_top20_cost_share']:.1%}; selected cost mix R/C/S = {metrics['parameter_lp_selection_cost_share_R']:.1%}/{metrics['parameter_lp_selection_cost_share_C']:.1%}/{metrics['parameter_lp_selection_cost_share_S']:.1%}",
        ...
        f"- explicit multi-objective footprint LP: {metrics['multiobjective_footprint_lp_n_events']} events x {metrics['multiobjective_footprint_lp_n_lambdas']} lambdas = {metrics['multiobjective_footprint_lp_n_events'] * metrics['multiobjective_footprint_lp_n_lambdas']} LP solves; lambda=0 gain/LP = {metrics['multiobjective_footprint_lp_lambda0_fraction']:.4f}, footprint mass = {metrics['multiobjective_footprint_lp_lambda0_top5_mass']:.4f}; <=0.005 gain-loss best lambda = {metrics['multiobjective_footprint_lp_best_lambda_loss_0p005']:.3f}, footprint delta = {metrics['multiobjective_footprint_lp_best_delta_top5_loss_0p005']:+.4f}, gain delta = {metrics['multiobjective_footprint_lp_best_delta_fraction_loss_0p005']:+.4f}; max-footprint lambda = {metrics['multiobjective_footprint_lp_max_footprint_lambda']:.2f}, footprint mass = {metrics['multiobjective_footprint_lp_max_footprint_top5_mass']:.4f}, gain/LP = {metrics['multiobjective_footprint_lp_max_footprint_fraction']:.4f}",
        f"- broader explicit multi-objective footprint LP: {metrics['broader_multiobjective_footprint_lp_n_events']} events x {metrics['broader_multiobjective_footprint_lp_n_lambdas']} lambdas = {metrics['broader_multiobjective_footprint_lp_n_events'] * metrics['broader_multiobjective_footprint_lp_n_lambdas']} LP solves; lambda=0 gain/LP = {metrics['broader_multiobjective_footprint_lp_lambda0_fraction']:.4f}, footprint mass = {metrics['broader_multiobjective_footprint_lp_lambda0_top5_mass']:.4f}; <=0.005 gain-loss best lambda = {metrics['broader_multiobjective_footprint_lp_best_lambda_loss_0p005']:.3f}, footprint delta = {metrics['broader_multiobjective_footprint_lp_best_delta_top5_loss_0p005']:+.4f}, gain delta = {metrics['broader_multiobjective_footprint_lp_best_delta_fraction_loss_0p005']:+.4f}; max-footprint lambda = {metrics['broader_multiobjective_footprint_lp_max_footprint_lambda']:.2f}, footprint mass = {metrics['broader_multiobjective_footprint_lp_max_footprint_top5_mass']:.4f}, gain/LP = {metrics['broader_multiobjective_footprint_lp_max_footprint_fraction']:.4f}",
        f"- New York footprint LP boundary: {metrics['new_york_footprint_boundary_n_events']} selected New York events have finite top-5% footprint mass {metrics['new_york_footprint_boundary_mean_base_finite_top5']:.4f} -> {metrics['new_york_footprint_boundary_mean_hybrid_finite_top5']:.4f} (delta {metrics['new_york_footprint_boundary_mean_delta_finite_top5']:+.4f}); prior direct hybrid LP attempts unresolved = {metrics['new_york_footprint_boundary_prior_time_limit']}/{metrics['new_york_footprint_boundary_prior_attempted']} ({metrics['new_york_footprint_boundary_prior_time_limit_event_ids'] or 'none'}); max model size = {metrics['new_york_footprint_boundary_max_units']:,} zones, {metrics['new_york_footprint_boundary_max_variables']:,} variables, {metrics['new_york_footprint_boundary_max_constraints']:,} constraints, {metrics['new_york_footprint_boundary_max_access_terms']:,} access terms; variables/access terms vs V42 max = {metrics['new_york_footprint_boundary_variable_ratio']:.2f}x/{metrics['new_york_footprint_boundary_access_ratio']:.2f}x",
        f"- New York active-set screening: token-column {metrics['new_york_active_set_recommended_strategy']} at {metrics['new_york_active_set_recommended_fraction']:.0%} per-signal top share uses {metrics['new_york_active_set_recommended_active_token_fraction']:.1%} of action tokens and reduces total variables by {metrics['new_york_active_set_recommended_variable_reduction']:.1%}, while capturing small/finite/footprint mass {metrics['new_york_active_set_recommended_small_capture']:.1%}/{metrics['new_york_active_set_recommended_finite_capture']:.1%}/{metrics['new_york_active_set_recommended_footprint_capture']:.1%}; near-complete capture needs {metrics['new_york_active_set_full_capture_active_token_fraction']:.1%} of action tokens, so New York closure needs column generation rather than regional downsampling.",
        ...
        "## 论文写作含义",
        "",
        "The current learning/law section can be written as a full evidence chain: optimization produces an action-value field; single-action LPs validate the marginal label; cross-city, factorized, and symbolic surrogates support a compact activated law; residual greedy shows that finite budgets require residual re-scoring; event top-tail tests separate decision-criticality from disruption magnitude; V29/V30 show that non-obvious activation survives parameter perturbations and appears in selected LP support; V31 strengthens representative scenario-specific optimum closure to 26/28 optimal non-base rows; V32 prevents over-claiming by showing that present event top-tail concentration is mostly a city-template signal; V33 shows that raw TMC speed data contain event-zone footprint signal; V34 shows why this signal is invisible to the current small-signal label but visible to a magnitude-aware finite-value field; V35 shows that full LP support only weakly shifts toward footprints; V36 explains that the weak transfer is mainly a mismatch between finite footprint magnitude and small-signal OD action value, not simple period-budget or cap saturation; V37 shows that footprint can enter as a gated refinement rather than a replacement law; V38 shows that this refinement must remain weak in static finite-budget replay because strong footprint/finite weighting sacrifices recovery gain; V39 shows that adaptive residual re-scoring captures most recovery gain already; V40 makes the replay frontier explicit; V41 confirms the same boundary inside the LP objective itself; V42 shows the direct LP frontier persists across 12 additional footprint-sensitive city-events, where small footprint weights act as near-free tie-breakers but larger footprint coverage requires true recovery-gain loss; V43 shows that the remaining New York footprint gap is a scale/solver boundary despite strong footprint signal; V44 shows that New York cannot be closed by simply deleting most regions because near-complete value capture requires most action columns even when footprint mass is concentrated. The remaining caveats are still important: graph evidence is OD-dependency alignment rather than a full road-adjacency/GNN closure; calendar holdout remains city-confounded; intervention parameters remain management-regime assumptions rather than observed causal intervention effects; the two unresolved New York scenario-optimum rows and the unresolved New York hybrid-footprint LP row are computational boundaries; and the next major model step is New York-scale column generation or active-set LP expansion if footprint coverage becomes a primary claim.",
    ]
