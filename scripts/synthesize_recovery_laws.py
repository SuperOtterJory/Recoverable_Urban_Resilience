    ...
    return pd.DataFrame(
        [
            ...
            },
            {
                ...
                "next_step": "If footprint-specific recovery law becomes a main claim, include the unresolved New York-scale cases and test city-specific social-preference weights.",
            },
            {
