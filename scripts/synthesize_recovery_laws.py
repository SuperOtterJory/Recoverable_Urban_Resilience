    ...
    return pd.DataFrame(
        [
            ...
            },
            {
                ...
                "next_step": "If footprint-specific recovery law becomes a main claim, close New York-scale direct LPs with solver tuning, decomposition, or warm-start bases and test city-specific social-preference weights.",
            },
            {
...
def write_report(
    ...
    lines = [
        "# Recoverability Law Synthesis V42",
        "",
        "V42 broadens the explicit footprint objective test beyond the six representative hybrid events. It asks whether the recovery-footprint frontier remains visible across more footprint-sensitive city-events at full-zone scale.",
        "",
        "## 本版做了什么",
        "",
