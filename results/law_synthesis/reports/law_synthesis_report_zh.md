...
| intervention_parameter_identification | R/C/S effectiveness, cost, caps, delays, and diminishing returns are recovery-regime assumptions; V20 adds parameter-deconfounded action-token tests.          | The law is still conditional on the specified management regime, but OD exposure and future-loss alignment remain informative beyond action mechanics.       | Run full LP parameter ensembles or incorporate observed intervention records if parameter identification becomes a central claim.          |
